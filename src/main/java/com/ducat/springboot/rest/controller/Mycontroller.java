...
@RestController
@Tag(name = "Employee Management Service Controller")
public class Mycontroller {
	...
	@Operation(summary = "This service is to update employee details by Id.")
	...
	@Operation(summary = "This service is to delete employee details by Id.")
